...
public class WeatherAndForecastFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        // Inflate the layout for this fragment, containing the child fragments
        return inflater.inflate(R.layout.fragment_weather_and_forecast_pager_adapter, container, false);
    }
}
